...
export default function Show ({ pizza }) {
  ...
  return (
    <div className="max-w-3xl mx-auto py-12">
      ...
      <div className="text-cetner mt-4">
        <p className="test-lg">{pizza.chef} started {pizza.status.toLowerCase()} your order <span className="underline font-semibold">{pizza.last_updated}</span></p>
      </div>
    </div>
  )
}